                ...
                <div class="container-fluid">
                    ...
                    <div class="logo">
                        ...
                        <a href="{{ asset('admin') }}" class="logo">
                            ...
                            <span class="logo-large"><i class="mdi mdi-radar"></i> AntKing1109</span>
                        </a>
                        <!-- Image Logo -->
                    ...
                    <div class="menu-extras topbar-custom">
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="{{ asset(Auth::user()->avatar) }}" alt="user" class="rounded-circle"> <span class="ml-1 pro-user-name">{{ Auth::user()->name }} <i class="mdi mdi-chevron-down"></i> </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                    ...
                                    <!-- item-->
                                    <a href="{{ asset('admin/user/' . Auth::id()) }}" class="dropdown-item notify-item">
                                        <i class="fi-head"></i> <span>My Account</span>
                                    </a>

                                    <!-- item-->
                                    <a href="{{ asset('admin/setting') }}" class="dropdown-item notify-item">
                                        <i class="fi-cog"></i> <span>Settings</span>
                                    </a>

                                    <!-- item-->
                                    <a href="{{URL::asset('logout')}}" class="dropdown-item notify-item">
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                <a href="{{ asset('admin') }}"><i class="fi-air-play"></i>Dashboard</a>
                            </li>

                            <li class="has-submenu">
                                <a href="{{ asset('admin/image')}}"><i class="fi-briefcase"></i>Image Manage</a>
                            </li>

                            <li class="has-submenu">
                                <a href="{{ asset('admin/image/add')}}"><i class="fi-box"></i>Add Image</a>
                            </li>
                        </ul>
                        <!-- End navigation menu -->
                    </div> <!-- end #navigation -->
